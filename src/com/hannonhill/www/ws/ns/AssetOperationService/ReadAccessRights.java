...
@SuppressWarnings({"serial", "unchecked"}) public class ReadAccessRights  implements java.io.Serializable {
    private com.hannonhill.www.ws.ns.AssetOperationService.Identifier identifier;

    public ReadAccessRights() {
    }
    ...
    /**
     * Gets the identifier value for this ReadAccessRights.
     * 
     * @return identifier
     */
    ...
    /**
     * Sets the identifier value for this ReadAccessRights.
     * 
     * @param identifier
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ReadAccessRights)) return false;
        ReadAccessRights other = (ReadAccessRights) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ReadAccessRights.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.hannonhill.com/ws/ns/AssetOperationService", "readAccessRights"));
