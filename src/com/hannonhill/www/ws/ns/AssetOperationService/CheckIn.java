...
@SuppressWarnings({"serial", "unchecked"}) public class CheckIn  implements java.io.Serializable {
    ...
    /**
     * Gets the identifier value for this CheckIn.
     * 
     * @return identifier
     */
    ...
    /**
     * Sets the identifier value for this CheckIn.
     * 
     * @param identifier
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.hannonhill.com/ws/ns/AssetOperationService", "checkIn"));
