/**
 * StructuredDataDefinitionContainer.java
 *
...
@SuppressWarnings({"serial", "unchecked"}) public class StructuredDataDefinitionContainer  extends com.hannonhill.www.ws.ns.AssetOperationService.ContaineredAsset  implements java.io.Serializable {
    private com.hannonhill.www.ws.ns.AssetOperationService.Identifier[] children;

    public StructuredDataDefinitionContainer() {
    }
    ...
    /**
     * Gets the children value for this StructuredDataDefinitionContainer.
     * 
     * @return children
     */
    ...
    /**
     * Sets the children value for this StructuredDataDefinitionContainer.
     * 
     * @param children
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof StructuredDataDefinitionContainer)) return false;
        StructuredDataDefinitionContainer other = (StructuredDataDefinitionContainer) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(StructuredDataDefinitionContainer.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.hannonhill.com/ws/ns/AssetOperationService", "structuredDataDefinitionContainer"));
