...
@SuppressWarnings({"serial", "unchecked"}) public class EntityType  implements java.io.Serializable {
    ...
    public EntityType(
           com.hannonhill.www.ws.ns.AssetOperationService.EntityTypeString name) {
           this.name = name;
    }
     ...
     * @return name
     */
    public com.hannonhill.www.ws.ns.AssetOperationService.EntityTypeString getName() {
        return name;
    }
     ...
     * @param name
     */
    public void setName(com.hannonhill.www.ws.ns.AssetOperationService.EntityTypeString name) {
        this.name = name;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.hannonhill.com/ws/ns/AssetOperationService", "entity-type"));
