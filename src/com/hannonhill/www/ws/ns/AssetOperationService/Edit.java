...
@SuppressWarnings({"serial", "unchecked"}) public class Edit  implements java.io.Serializable {
    ...
    /**
     * Gets the asset value for this Edit.
     * 
     * @return asset
     */
    ...
    /**
     * Sets the asset value for this Edit.
     * 
     * @param asset
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.hannonhill.com/ws/ns/AssetOperationService", "edit"));
