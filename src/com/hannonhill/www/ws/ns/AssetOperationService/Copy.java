...
@SuppressWarnings({"serial", "unchecked"}) public class Copy  implements java.io.Serializable {
    private com.hannonhill.www.ws.ns.AssetOperationService.Identifier identifier;

    private com.hannonhill.www.ws.ns.AssetOperationService.CopyParameters copyParameters;
    ...
    public Copy(
           ...
           com.hannonhill.www.ws.ns.AssetOperationService.CopyParameters copyParameters,
    ...
    /**
     * Gets the identifier value for this Copy.
     * 
     * @return identifier
     */
    ...
    /**
     * Sets the identifier value for this Copy.
     * 
     * @param identifier
     */
    ...
    /**
     * Gets the copyParameters value for this Copy.
     * 
     * @return copyParameters
     */
    public com.hannonhill.www.ws.ns.AssetOperationService.CopyParameters getCopyParameters() {
        return copyParameters;
    }


    /**
     * Sets the copyParameters value for this Copy.
     * 
     * @param copyParameters
     */
    public void setCopyParameters(com.hannonhill.www.ws.ns.AssetOperationService.CopyParameters copyParameters) {
        this.copyParameters = copyParameters;
    }


    /**
     * Gets the workflowConfiguration value for this Copy.
     * 
    ...
    /**
     * Sets the workflowConfiguration value for this Copy.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        ...
        _equals = true && 
            ...
            ((this.copyParameters==null && other.getCopyParameters()==null) || 
             (this.copyParameters!=null &&
              this.copyParameters.equals(other.getCopyParameters()))) &&
    ...
    public synchronized int hashCode() {
        ...
        if (getCopyParameters() != null) {
            _hashCode += getCopyParameters().hashCode();
        }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.hannonhill.com/ws/ns/AssetOperationService", "copy"));
        ...
        elemField.setFieldName("copyParameters");
        elemField.setXmlName(new javax.xml.namespace.QName("http://www.hannonhill.com/ws/ns/AssetOperationService", "copyParameters"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.hannonhill.com/ws/ns/AssetOperationService", "copyParameters"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
