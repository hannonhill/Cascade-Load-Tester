...
@SuppressWarnings({"serial", "unchecked"}) public class Read  implements java.io.Serializable {
    ...
    /**
     * Gets the identifier value for this Read.
     * 
     * @return identifier
     */
    ...
    /**
     * Sets the identifier value for this Read.
     * 
     * @param identifier
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.hannonhill.com/ws/ns/AssetOperationService", "read"));
