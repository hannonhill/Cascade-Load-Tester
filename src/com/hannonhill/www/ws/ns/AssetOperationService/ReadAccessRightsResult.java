...
@SuppressWarnings({"serial", "unchecked"}) public class ReadAccessRightsResult  extends com.hannonhill.www.ws.ns.AssetOperationService.OperationResult  implements java.io.Serializable {
    private com.hannonhill.www.ws.ns.AssetOperationService.AccessRightsInformation accessRightsInformation;

    public ReadAccessRightsResult() {
    }
    ...
    /**
     * Gets the accessRightsInformation value for this ReadAccessRightsResult.
     * 
    ...
    /**
     * Sets the accessRightsInformation value for this ReadAccessRightsResult.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ReadAccessRightsResult)) return false;
        ReadAccessRightsResult other = (ReadAccessRightsResult) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ReadAccessRightsResult.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.hannonhill.com/ws/ns/AssetOperationService", "readAccessRightsResult"));
