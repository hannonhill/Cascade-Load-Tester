...
@SuppressWarnings({"serial", "unchecked", "unused"}) public class Block  extends com.hannonhill.www.ws.ns.AssetOperationService.ExpiringAsset  implements java.io.Serializable {
    public Block() {
    }
